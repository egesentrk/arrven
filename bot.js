...
const embed = new Discord.RichEmbed()
.setColor('RANDOM')
.setTitle('Arven Roleplay - YAKINDA!')
.setDescription(`📢-Merhabalar, **Arven Roleplay ** yakında sizlerle discord adresimizden bizimle irtibatta kalabilirsiniz, anlayışınız için teşekkür ederiz.`)
.setImage(`https://cdn.discordapp.com/attachments/722346361747537981/734523806047010927/ddd.png`);
member.send(embed)
})
